...
from .forms import FYform,ServiceMetaForm,ServiceForm,OfficeForm,rasidAllocationForm, UserManagementForm,PaymentMethodForm
from .models import ServiceMeta,Service,Office,RasidAllocation,relmap,FY,Bill,PaymentMethod,Cancelled,Estimated,Profile
# Create your views here.
